...
DEFAULT_API_BASE_URL = os.getenv("DEFAULT_API_BASE_URL", "https://[your-domain]")
...
st.set_page_config(page_title="[YourBrand] Auto Sales API Playground", layout="wide")
init_state()
seed_data = load_seed_data()

st.title("[YourBrand] Auto Sales API Playground")

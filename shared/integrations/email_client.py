...
class EmailClient:
    ...
    def send_test_email(self, to_email: str, subject: str = "[YourBrand] SMTP Test") -> bool:
        html = """
        <html>
          <body>
            <h3>SMTP test successful</h3>
            <p>Your [YourBrand] Auto SMTP integration is working.</p>
          </body>
        </html>
        """
        text = "SMTP test successful. Your [YourBrand] Auto SMTP integration is working."

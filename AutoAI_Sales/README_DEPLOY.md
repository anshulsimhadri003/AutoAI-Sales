...
- `https://autosalesai.halcyontek.com/` -> Streamlit UI
- `https://autosalesai.halcyontek.com/api/*` -> FastAPI
- `https://autosalesai.halcyontek.com/health` -> FastAPI
- `https://autosalesai.halcyontek.com/health/ready` -> FastAPI
...
- `deploy/nginx/autosalesai.halcyontek.com.conf` for same-domain path routing
...
1. Copy `deploy/nginx/autosalesai.halcyontek.com.conf` to your Nginx sites directory
2. Enable the site
3. Test and reload:
...
```bash
./scripts/verify_deploy.sh https://autosalesai.halcyontek.com
```

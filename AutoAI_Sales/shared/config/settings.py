...
class Settings(BaseSettings):
    app_name: str = "Halcyon Auto Sales AI API"
    app_env: str = "development"
    debug: bool = False

    database_url: str = "sqlite:///./halcyon_auto_sales.db"
    db_pool_size: int = 10
    ...
    public_sales_url: str = "https://autosalesai.halcyontek.com"
    cors_origins: list[str] | str = ["https://autosalesai.halcyontek.com"]
    ...
    semantic_faiss_enabled: bool = True
    ...
    email_from_name: str = "Halcyon Auto Sales"
    email_reply_to: str | None = None
    appointment_email_subject_prefix: str = "Halcyon Auto"
    ...
    def validate_production_requirements(self):
        ...
        if self.is_production:
            insecure_tokens = {"dev-only-change-me", "dev-internal-admin-token", "change-this-in-production", "halcyon-admin-dev-token"}
